...
!function (e, n) {
    "function" == typeof define && define.amd ? define(["exports", "echarts"], n) : "object" == typeof exports && "string" != typeof exports.nodeName ? n(exports, require("echarts")) : n({}, e.echarts)
}(this, function (e, n) {
    var a = function (e) {
        "undefined" != typeof console && console && console.error && console.error(e)
    };
    n ? n.registerMap ? n.registerMap("台湾省", {
        type: "FeatureCollection", features: [{
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@CIQNM^DJD@HGDMROAE"], ["@@Uq@B^ BAD@KcAI"], ["@@A@\\FB@M_y"], ["@@AQ@@DDAEw"], ["@@M¥L_dY\\@jRhD\\GEQo«¹q{ysqeomisUcSgo_qQ[S_IHE¹PeP]~ADoY@@GlMZ]\\fXTlGfqFIKGYMQY@IPDrER_NQOMSUEUREZFXHPXL\\BXHHVIJR@N~@ERa\\UVF\\TLTFLRG\\IVHVJZRTCPDPZLLTF[PL^hMIxKpTTblZtfdbp`~Z¶TBxO`QP]LcHu"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@\\uHDVFXBPC@EGIGK@OHGRK@@aSwUWODSVYNYVW\\WXO]hC`JRLDR[\\ATBŎ{XMKYCUFcT}T[PEvF\\AbG\\MPQ]@@EHYNmI][QOKSTYMYaU[G]MW[WcgYoM§w¥e]Oe[Mc@[HWDM]SsUeW]WeKmKQf|IhGdZZJfgNyCgTJpGdgdIdJjAj\\^¦ZZZH\\C^gtaP]FYTcVqV_`@@NdNpdNFRDX@\\GNSJQLKZJ[hkjWNFRNLPFFFPdXjtjbRIdW¡", "@@MQKS\\]ngJkMs`ol_^]\\WfEnA`N|N^[XcRAdNnM`]XQMZKVCZFXQP[H_MUOm[[O_"], ["@@OIATRI"]],
